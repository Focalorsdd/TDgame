...
protected:
	...
	{
		//初始化+错误断言
		init_assert(!SDL_Init(SDL_INIT_EVERYTHING),u8"SDL 2 初始化失败");
...
private:
	...
	bool generate_tile_map_texture()
	{
		...
		tex_tile_map = SDL_CreateTexture(renderer, 
			SDL_PIXELFORMAT_ARGB8888, SDL_TEXTUREACCESS_TARGET, width_tex_tile_map, height_tex_tile_map);
